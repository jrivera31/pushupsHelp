...
Our variable analysis gives pushups as numerical variables and position as a factor variable.  The two variables of interest are push ups and position. Graphical displays would include boxplots as a first thing to look at.
#Results
...
The null hypothesis $H_0$ is, "there is a difference between the amount of pushups of players on the line or skill positions"

The boxplot indicates a significant difference between the pushup amounts of players in the two positions, the numerical summary show line players pushups, on average 17.12500, and the skill players push ups an average of 49.72727

a t-test of difference in means gave a p-value of .000009421, this is more than 0.05, so we reject the null hypothesis and conclude we have evidence there is a significant difference between the average push ups of skill players and line players.
